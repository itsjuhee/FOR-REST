    ...
    <article class="p_addList">
        ...
        <div>
            ...
            <tr>                
                <th>요약정보</th>
                <td colspan="3">
                    <textarea name="p_info"><?=nl2br($row['p_info'])?>
                    </textarea>
            ...
            <tr>                
                ...
                <td colspan="3">
<?
    if(!empty($row['p_photo'])){
        $imgSrc = "src=../file/".$row['p_photo'];
    }else{
        $imgSrc = '';
    }
?>
                    <span><img <?=$imgSrc?> id="img_prv" ></span>
        ...
        <h2>상세설명</h2>
        <div class="smediter">
            <textarea name="p_detail" id="p_detail">
                <?=nl2br($row['p_detail'])?>
            </textarea>
    ...
    try {
        ...
        product.action = 'itemReg.php?mode=modify';
