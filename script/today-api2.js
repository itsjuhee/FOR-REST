...
$.ajax({
    method: "GET",
    // url: "http://api.visitkorea.or.kr/openapi/service/rest/GoCamping/basedList?ServiceKey=qqWljV6cxHPr2tcjP5ckf1nfrLkMMrqXb8pHNUfmtPDzSBTVUgVD3M6xIMrE4j9vYjI3fUB5xUhhnM8Jl0AUdA%3D%3D&numOfRows=3000&pageNo=1&MobileOS=WIN&MobileApp=forest&_type=json",
    ...
    success:function(data){
        ...
        function printFn(){
            ...
            $.each(dd, function(k,thum){
                if(thum.firstImageUrl != undefined && k < 10){
