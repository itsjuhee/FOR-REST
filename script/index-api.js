...
$.ajax({
    ...
    success:function(data){
        ...
        function printFn(d){
            ...
            $.each(d, function(k,thum){
                if(thum.firstImageUrl != undefined){
                    thumnail += `<div class="m-main" data-code=${thum.contentId}>
                                    <div class="m-img">
                                        <img src="${thum.firstImageUrl}">
                                    </div>
                                ...
                                <hr>
                                <div class="info">
                                    <div><p class="p">캠핑형태</p><span>${thum.induty}</span></div>
                                    <div><p class="p">환경</p><span>${thum.lctCl}</span></div>
                                    <p class="arrow1">아이콘</p>
                                </div>
                                <div class="info-on">
                                    <div><p class="p">대표번호</p><span>${thum.tel}</span></div>
                                    <div><p class="p">예약구분</p><span>${thum.resveCl}</span></div>
                ...
                $('.mobile-main-wrap').html(thumnail);
            }
        ...
        // 적용하기 버튼
        $('.filter .btn a:nth-of-type(1)').on('click', function(){
            let dd=[];
            ...
            function popupSlide (idx){
                ...
                let code = $('.mobile-main-wrap .m-main').eq(idx).data('code');
            ...
            $('.m-main .m-title .info-on .btn').on('click', function(){
